...
Leif Azzopardi$^{1}$, Yashar Mosfeghi$^{2}$, Martin Halvey$^{1}$, \\Krisztian Balog$^{3}$, Juan Manual Fernandez Luna $^{4}$, Charlie Hull$^{5}$,\\ Sauparna Palchowdhury$^{6}$\\
	...
	$^{6}$ {\small NIST \emph{\small sauparna.palc@gmail.com}}
}
